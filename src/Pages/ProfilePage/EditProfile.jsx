          ...
          {formLoading ? (
            ...
            <div className="space-y-8">
              <form onSubmit={handleUpdateUsername} className="space-y-4">
                ...
                <button
                  type="submit"
                  className="w-full py-3 px-4 bg-green-500 text-white font-semibold rounded-lg hover:bg-green-600 transition-colors duration-300 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500 dark:focus:ring-offset-gray-900"
                >
                  Update Username
                </button>
              </form>
              ...
              <form onSubmit={handleUpdatePassword} className="space-y-4">
                ...
                <button
                  type="submit"
                  className="w-full py-3 px-4 bg-blue-600 text-white font-semibold rounded-lg hover:bg-blue-700 transition-colors duration-300 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 dark:focus:ring-offset-gray-900"
                >
                  Ganti Password
                </button>
              </form>
