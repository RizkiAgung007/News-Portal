  ...
  return (
    ...
    <div className="">
      ...
      <div className="flex justify-between items-center mb-4">
        <h1 className="text-3xl font-semibold text-gray-800 dark:text-gray-100">Manajemen Berita</h1>
      ...
      <p className="text-gray-600 dark:text-gray-400 mb-6">
        Total Berita: <strong className="text-green-600 dark:text-green-400">{news.length}</strong>
      </p>
      ...
      <div className="overflow-x-auto rounded-lg border border-gray-200 dark:border-gray-700">
        <table className="w-full min-w-[600px] table-auto text-left">
          <thead className="bg-green-50 dark:bg-gray-700/50 text-green-800 dark:text-green-300">
            <tr>
              <th className="p-3 border-b border-gray-300 dark:border-gray-600 text-center font-medium">No</th>
              <th className="p-3 border-b border-gray-300 dark:border-gray-600 text-center font-medium">News</th>
              <th className="p-3 border-b border-gray-300 dark:border-gray-600 text-center font-medium">Category</th>
              <th className="p-3 border-b border-gray-300 dark:border-gray-600 text-center font-medium">Created At</th>
              <th className="p-3 border-b border-gray-300 dark:border-gray-600 text-center font-medium">Action</th>
            </tr>
          </thead>
          <tbody className="divide-y divide-gray-200 dark:divide-gray-700">
            {news.map((item, index) => (
              ...
              >
                <td className="p-3 border-b border-gray-200 dark:border-gray-700 text-center text-gray-700 dark:text-gray-300">{index + 1}</td>
                <td className="p-3 border-b border-gray-200 dark:border-gray-700 text-center font-semibold text-gray-900 dark:text-white">{item.title}</td>
                <td className="p-3 border-b border-gray-200 dark:border-gray-700 text-center text-gray-700 dark:text-gray-400">{item.category}</td>
                <td className="p-3 border-b border-gray-200 dark:border-gray-700 text-center text-gray-700 dark:text-gray-400">{new Date(item.create_at).toLocaleDateString()}</td>
